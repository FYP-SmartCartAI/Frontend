          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                {['Subject', 'User', 'Order', 'Created', 'Status', 'Action'].map((h) => (
              ...
              {isLoading
                ...
                : tickets.map((ticket) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-text-secondary text-xs">{ticket.userId?.name || '—'}</td>
                    <td className="px-4 py-3 text-text-secondary text-xs font-[var(--font-mono)]">{orderShort(ticket.orderId)}</td>
                    <td className="px-4 py-3 text-text-tertiary text-xs">{formatRelativeTime(ticket.createdAt)}</td>
